...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Developed an AI Safety Dashboard with real-time monitoring and risk visualization, enhancing incident detection efficiency by 30% through streamlined data workflows and ensuring 100% responsiveness across devices for seamless cross-platform accessibility.",
    tags: ["Html", "Css","ThreeJs" ,"JavaScript", "Bootstrap","TypeScript"],
    imageUrl: "/train.jpg",
    githubUrl: "https://github.com/iUtkarshtiwari/AI-Safety-Dashboard",
    demoUrl: "https://ai-safetydashboard.netlify.app/"
  },
  {
    ...
    imageUrl: "/NQueen.jpg",
    githubUrl: "https://github.com/iUtkarshtiwari/NQueen",
    demoUrl: "https://iutkarshtiwari.github.io/NQueen/"
  },
  {
    title: "Travel Budget Website",
    description: "Developed a responsive travel budget planner using PHP and the Laravel framework. The platform allows users to plan trips by inputting destinations, travel dates, and expenses, automatically generating a detailed budget. Integrated user authentication, dynamic forms, and real-time cost summaries to enhance user experience and financial planning.",
    tags: ["Html", "Css", "TypeScript", "JavaScript"],
    imageUrl: "/Travel.jpg",
    githubUrl: "https://github.com/iUtkarshtiwari/TravelBudgetWebsite",
    demoUrl: "/"
  }
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Button
            ...
            asChild
          >
            <a href="https://github.com/iUtkarshtiwari" target="_blank" rel="noopener noreferrer">
