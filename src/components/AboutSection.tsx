      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-tech-light/70 max-w-2xl mx-auto">
            A passionate Software Engineer and Full-Stack Developer with expertise in building modern web applications and data-driven solutions.
          </p>
        </motion.div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          >
            ...
            <p className="text-tech-light/80">
              I'm Utkarsh Tiwari, a Software Engineer and Full-Stack Developer based in Indore, Madhya Pradesh. With a background in Computer Science and Engineering (CGPA 7.41), 
              I specialize in creating efficient and scalable applications that solve real-world problems.
            </p>
            <p className="text-tech-light/80">
            My expertise spans across Full Stack Web Development and Software Development. I have hands-on experience working with diverse technologies, including front-end and back-end frameworks.
             I am proficient in Java, PowerBI, C++, ReactJs, NodeJs, SQL,and various database management systems
             with a strong foundation in building scalable and efficient web applications.  </p>
            <p className="text-tech-light/80">
            ...
            <div className="pt-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-tech-light/70">Lovely Professional University, Jalandhar,Punjab | CGPA 7.41 | Aug 2022 - Present</p>
                </div>
                <div>
                  <p className="font-medium text-tech-light">St Mary's Convent Senior Secondary School,Dewas</p>
