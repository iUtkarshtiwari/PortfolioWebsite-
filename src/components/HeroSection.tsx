    ...
    <section id="home" className="relative min-h-screen flex flex-col justify-center">
      ...
      <div className="container mx-auto px-4 z-10 pt-20">
        <div className="max-w-3xl">
          ...
          >
            Software Engineer & Full-Stack WebDeveloper
          </motion.h2>
          ...
          >
            ...
            Specialized in full-stack web development, software engineering, and data-driven solutions 
            with a strong foundation in data analytics and system design.
          </motion.p>
